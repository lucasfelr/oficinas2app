          ...
          if (globals.exs[globals.iteradorex]['Contagem'] == true)
            new SettingRow(
              rowData: SettingsSliderConfig(
                ...
                from: 0,
                to: 100,
                initialValue: globals.exsim[globals.iteradorex]['Contagem'],
                justIntValues: true,
                unit: ' %',
              ),
          ...
          if (globals.exs[globals.iteradorex]['Cor'] == true)
            new SettingRow(
              rowData: SettingsSliderConfig(
                ...
                from: 0,
                to: 100,
                initialValue: globals.exsim[globals.iteradorex]['Cor'],
                justIntValues: true,
                unit: ' %',
              ),
              onSettingDataRowChange: (double resultVal) {
          ...
          if (globals.exs[globals.iteradorex]['Forma'] == true)
            new SettingRow(
              rowData: SettingsSliderConfig(
                ...
                from: 0,
                to: 100,
                initialValue: globals.exsim[globals.iteradorex]['Forma'],
                justIntValues: true,
                unit: ' %',
              ),
              onSettingDataRowChange: (double resultVal) {
          ...
          if (globals.exs[globals.iteradorex]['Dia'] == true)
            new SettingRow(
              rowData: SettingsSliderConfig(
                ...
                from: 0,
                to: 100,
                initialValue: globals.exsim[globals.iteradorex]['Dia'],
                justIntValues: true,
                unit: ' %',
              ),
              onSettingDataRowChange: (double resultVal) {
